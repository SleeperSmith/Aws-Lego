param(
    ...
    $kp = (Read-Host 'Name of Key Pair to user for Jenkins Server instances access'),
    $ami = (Read-Host 'AMI ID of Jenkins Master Server (Ubuntu)'),
    $winami = (Read-Host 'AMI ID of Jenkins Windows Build Agent (Windows)'),
    $tags = @(
